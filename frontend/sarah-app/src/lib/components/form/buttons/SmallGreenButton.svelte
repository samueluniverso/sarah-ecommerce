...
<button on:click={onClick} class="flex justify-center items-center bg-sarah-green text-sarah-white p-1 hover:brightness-75 transition duration-300 px-3 py-1 text-center me-1 mb-1" {type}>
    {#if Icon}
